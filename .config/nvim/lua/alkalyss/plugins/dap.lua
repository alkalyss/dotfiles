...
return {
	...
	},
	{
		...
		config = function ()
			...
			vim.keymap.set('n', '<leader>cp', function() dap.set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, {desc = "Set [C]onditional break[P]oint"})
			vim.keymap.set('n', '<leader>lp', function() dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, {desc = "Set [L]ogging break[P]oint"})
		end
	}
}
